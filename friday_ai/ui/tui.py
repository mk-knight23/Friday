...
from friday_ai.utils.paths import display_path_rel_to_cwd
import re

from friday_ai.utils.text import truncate_text
    ...
    def _render_args_table(self, tool_name: str, args: dict[str, Any]) -> Table:
        ...
        for key, value in self._ordered_args(tool_name, args):
            if isinstance(value, str):
                ...
                # Convert any non-string value (int, float, bool, list, dict, etc.) to string
                value = str(value)
